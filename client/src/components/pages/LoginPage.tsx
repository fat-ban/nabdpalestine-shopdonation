  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-br from-palestine-black/60 via-palestine-red/40 to-palestine-green/60"></div>
        ...
        <div className="absolute inset-0 flex items-center justify-center p-8">
          <div className="text-center text-white">
            ...
            <h2 className="text-3xl font-bold mb-4 text-shadow-lg">
              {language === 'ar' ? 'أهلاً بك في نبض فلسطين' : 'Welcome to Palestine Pulse'}
            </h2>
            <p className="text-lg opacity-90 text-shadow max-w-md">
              {language === 'ar' 
                ? 'منصة التضامن الرقمي والتبرع الشفاف لدعم القضية الفلسطينية'
                : 'Digital solidarity platform with transparent donations supporting Palestine'
              }
            </p>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-md space-y-6">
          ...
          <Card className="border-palestine-red/20 shadow-lg">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="text-sm text-muted-foreground text-center">
                  <span className="text-palestine-red">
                    {language === 'ar' ? 'للتجربة: ' : 'Demo: '}
                  </span>
                  admin@palestine-pulse.com / password
                </div>
                ...
                <div className="text-center text-sm">
                  ...
                  <Button
                    variant="link"
                    className="p-0 h-auto text-palestine-red hover:text-palestine-red-dark"
