...
import { Heart, Shield, Users, BookOpen, Home, Activity, DollarSign, CreditCard, Smartphone } from 'lucide-react';
  ...
  const donationCauses = [
    {
      ...
      description: language === 'ar' ? 'دعم المدارس والطلاب الفلسطينيين' : 'Support Palestinian schools and students',
      icon: BookOpen,
      raised: 75000,
      goal: 100000,
      color: 'bg-blue-500',
    ...
    {
      id: 'families',
      title: language === 'ar' ? 'العائلات' : 'Families',
      description: language === 'ar' ? 'مساعدة العائلات الفلسطينية المحتاجة' : 'Help Palestinian families in need',
      icon: Users,
      raised: 120000,
      goal: 150000,
    ...
    },
    {
      ...
      description: language === 'ar' ? 'إعادة بناء المنازل المدمرة' : 'Rebuild destroyed homes',
      icon: Home,
      raised: 50000,
      goal: 200000,
    ...
    {
      id: 'medical',
      title: language === 'ar' ? 'الرعاية الصحية' : 'Healthcare',
      description: language === 'ar' ? 'توفير العلاج والأدوية' : 'Provide medical treatment and medicines',
      icon: Activity,
      raised: 30000,
      goal: 80000,
      color: 'bg-red-500',
                    ...
                    <Select value={donationType} onValueChange={setDonationType}>
                      ...
                      <SelectContent>
                        <SelectItem value="general">
                          {language === 'ar' ? 'تبرع عام' : 'General Donation'}
                        </SelectItem>
                        <SelectItem value="education">
                          {language === 'ar' ? 'التعليم' : 'Education'}
                        </SelectItem>
                        <SelectItem value="families">
                          {language === 'ar' ? 'العائلات' : 'Families'}
                        </SelectItem>
                        <SelectItem value="housing">
                          {language === 'ar' ? 'الإسكان' : 'Housing'}
                        </SelectItem>
                    ...
                    <div className="bg-palestine-green-50 dark:bg-palestine-green-dark/20 p-4 rounded-lg">
                      ...
                      <ul className="space-y-2 text-sm">
                        ...
                        <li className="flex items-center gap-2">
                          ...
                          {language === 'ar' 
                            ? `${Math.floor(currentAmount / 15)} أدوية طبية`
                            : `${Math.floor(currentAmount / 15)} medical supplies`
                          }
                        </li>
                      </ul>
                    </div>
